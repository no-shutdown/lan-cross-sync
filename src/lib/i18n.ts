...
const messages = {
  'zh-CN': {
    ...
    autostart: '系统启动时运行',
    discoverable: '可被发现',
    broadcastingNow: '当前正在广播',
    notBroadcastingNow: '当前未广播，仅与已连接设备同步',
    searchDevices: '搜索设备',
    searchDevicesHint: '关闭后不再发现新设备，已配对设备的重连和同步不受影响',
    transfers: '文件传输',
    targetDevice: '目标设备',
    chooseTarget: '选择目标设备',
    ...
    dropRelease: '松手即发送',
    dropHint: '先选择一个在线的已配对设备',
    noTransferTarget: '请先选择在线的已配对设备',
    transferIdle: '暂无传输任务',
    incomingOffer: '收到文件传输请求',
    incomingOfferQueued: '还有 {count} 个请求等待处理',
    accept: '选择保存位置',
    reject: '拒绝',
    sending: '发送中',
    receiving: '接收中',
    ...
    errorInvalidDeviceName: '设备名称不能为空，且不能超过 40 个字符',
    notificationIncomingTitle: '收到文件传输请求',
    notificationIncomingBody: '{name} 想发送 {count} 个项目给你，点击查看',
    online: '在线',
    offline: '离线',
    discovered: '已发现',
    pairingState: '配对中',
  ...
  'en-US': {
    ...
    sendClipboard: 'Send clipboard content to this device',
    ...
    broadcastingNow: 'Currently broadcasting',
    notBroadcastingNow: 'Not broadcasting — syncing with connected devices only',
    searchDevices: 'Search for devices',
    searchDevicesHint: 'When off, no new devices are discovered; reconnecting and syncing paired devices is unaffected',
    ...
    dropRelease: 'Release to send',
    dropHint: 'Choose an online paired device first',
    ...
    incomingOfferQueued: '{count} more request(s) waiting',
    ...
    renameDevicePlaceholder: 'Enter a device name',
    errorInvalidDeviceName: 'Device name cannot be empty or longer than 40 characters',
    notificationIncomingTitle: 'Incoming file transfer request',
    notificationIncomingBody: '{name} wants to send you {count} item(s). Click to view.',
    online: 'Online',
    offline: 'Offline',
